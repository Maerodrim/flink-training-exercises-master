...
public class ExerciseBase {
	...
	public final static String pathToRideData = "K:/BIGData/big_data-master/data/nycTaxiRides.gz";
	public final static String pathToFareData = "K:/BIGData/big_data-master/data/nycTaxiFares.gz";
